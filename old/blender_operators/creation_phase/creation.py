...
from .hair import add_quality_props_to_hair_system, convert_to_new_hair_shader
from .material import set_gender_specific_shader
from ....human.base.namegen import get_name
...
#         context.view_layer.objects.active = hg_rig
#         self._configure_human_from_preset(
#             context, sett, gender, hg_body, hg_eyes, preset_data
#         )
...
#     def _configure_human_from_preset(
#         self, context, sett, gender, hg_body, hg_eyes, preset_data
#     ):
...
#         nodes = hg_body.data.materials[0].node_tree.nodes
#         for node_name, input_dict in preset_data["material"][
#             "node_inputs"
#         ].items():
...
#             ShowMessageBox(
#                 message=(
#                     "Could not find eyebrows named " + preset_data["eyebrows"]
#                 )
#             )
#         else:
