...
class HG_SETTINGS(bpy.types.PropertyGroup):
    ...
    pose_choice: EnumProperty(
        name="posing",
        items=[("library", "Library", "", 0), ("rigify", "Rigify", "", 1),],
        default="library",
    )
    ...
    expression_type: EnumProperty(
        name="Expression",
        items=[("1click", "1-Click", "", 0), ("frig", "Face Rig", "", 1),],
        default="1click",
    )
    ...
    gender: EnumProperty(
        ...
        items=[("male", "Male", "", 0), ("female", "Female", "", 1),],
        default="male",
    ...
    preset_thumbnail_enum: EnumProperty(items=get_preset_thumbnail,)
    ...
    batch_hair_quality_haircards: EnumProperty(
        ...
        items=[("low", "Low", "", 1), ("ultralow", "Ultra Low", "", 2),],
        default="low",
    )
    ...
    bake_res_body: EnumProperty(
        items=get_resolutions(), default="1024",
    )
    bake_res_eyes: EnumProperty(
        items=get_resolutions(), default="256",
    )
    ...
    saveoutfit_categ: EnumProperty(
        name="Clothing type",
        items=[("outfits", "Outfit", "", 0), ("footwear", "Footwear", "", 1),],
        default="outfits",
    )
