...
class BlendFile:
    ...
    def __init__(self, handle):
        ...
        while block.code != b"ENDB":
            ...
            #    print(f'block failed of size {block.size}', e)
        ...
        print([k for k in self.code_index])
    ...
    def ensure_subtype_smaller(self, sdna_index_curr, sdna_index_next):
        ...
        if (
            self.structs[sdna_index_curr].size
...
class BlendFileBlock:
    ...
    def get_file_offset(
        self, path, default=..., sdna_index_refine=None, base_index=0,
    ):
        """
        ...
        if sdna_index_refine is None:
            ...
            self.file.ensure_subtype_smaller(
                self.sdna_index, sdna_index_refine
            )
    ...
    def get_recursive_iter(
        ...
        try:
            ...
            struct_index = self.file.sdna_index_from_id.get(
                dna_type.dna_type_id, None
            )
            if struct_index is None:
                yield (
                    path_full,
                    "<%s>" % dna_type.dna_type_id.decode("ascii"),
                )
            else:
    ...
    def set(
        self, path, value, sdna_index_refine=None,
    ):
    ...
    def get_pointer(
        ...
        result = self.get(
            path,
            default,
            sdna_index_refine=sdna_index_refine,
...
class DNAStruct:
    ...
    def field_from_path(self, header, handle, path):
        ...
        if field is not None:
            ...
            if not name_tail:  # None or ()
                ...
                return field.dna_type.field_from_path(
                    header, handle, name_tail
                )

    def field_get(
        self, header, handle, path, default=..., use_nil=True, use_str=True,
    ):
    ...
    def field_set(self, header, handle, path, value):
        ...
        if dna_type.dna_type_id == b"char":
            ...
            raise NotImplementedError(
                "Setting %r is not yet supported for %r"
                % (dna_type, dna_name),
                dna_name,
                dna_type,
            )
